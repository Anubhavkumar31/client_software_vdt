...
from config.paths import Form, Window, resource_path, _dump_tally_to_temp
...
from widgets.midbar import MidBarSplitter, MidBarHandle
...
""")
        ...
        self.arrow_path = ICON_ARROW_DOWN.replace("\\", "/")
        url = QUrl.fromLocalFile(ICON_ARROW_DOWN).toString()
        print("DEBUG arrow:", ICON_ARROW_DOWN, os.path.exists(ICON_ARROW_DOWN))
