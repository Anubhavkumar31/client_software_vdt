...
def save_as_image():
    ...
    if not scrollable_active:
        ...
        try:
            ...
            x_left = min(x2, x3) - 5  # use small padding
...
def on_load_click():
    ...
    try:
        ...
        if len(sys.argv) > 1:
            ...
            # Now you can use the pipe_tally DataFrame
            df = pipe_tally  # This is your loaded DataFrame, you can use it here
        else:
            print("No pipe_tally file provided.")
    except Exception as e:
