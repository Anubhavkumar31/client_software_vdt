...
#     def __init__(self, parent=None, pipe_tally_df=None):
...
#     def _setup_ui(self):
#         """Setup the main UI layout with proper scrolling - KEEPS WORKING SCROLL"""
...
#         # ✅ Create scroll area with proper settings - UNCHANGED
...
#         # ✅ Create the scrollable content widget - UNCHANGED
#         content_widget = QWidget()
#         content_widget.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
#         content_widget.setMinimumHeight(1800)  # ✅ KEEPS working height
...
#         # Title
#         title = QLabel("Pipeline Highlights")
#         title.setAlignment(Qt.AlignmentFlag.AlignCenter)
#         title_font = QFont()
#         title_font.setPointSize(20)
#         title_font.setBold(True)
#         title.setFont(title_font)
#         title.setStyleSheet("color: #2c3e50; margin-bottom: 20px; padding: 10px;")
#         content_layout.addWidget(title)
        
#         # ✅ General Info Section
#         self._create_general_info_section(content_layout)
        
#         # ✅ Statistics and Charts Section - FIXED
#         self._create_statistics_section(content_layout)
        
#         # ✅ Add significant stretch to ensure scrollable content - UNCHANGED
...
#         print("✅ Embedded UI setup completed successfully!")

#     def _create_general_info_section(self, parent_layout):
#         """Create the general information section with proper layout"""
#         # General Info Frame
#         info_frame = QFrame()
...
#         info_title.setStyleSheet("color: #495057; margin-bottom: 15px; padding: 5px;")
#         info_layout.addWidget(info_title)
        
#         # ✅ Create proper grid for info items
...
#         """Create the statistics and charts section with FIXED layout"""
#         # ✅ Use QSplitter for resizable layout
#         splitter = QSplitter(Qt.Orientation.Horizontal)
#         splitter.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
        
#         # ✅ Statistics Frame (Left side) - COMPLETELY FIXED LAYOUT
#         stats_frame = QFrame()
...
#         stats_title.setStyleSheet("color: #495057; margin-bottom: 15px; padding: 5px;")
...
#         # ✅ SIMPLE and CLEAN layout approach - FIXED
...
#             # Create horizontal layout for each stat
...
#             stat_layout.addStretch()  # Push value to the right
#             stat_layout.addWidget(value_edit)
...
#         # ✅ Charts Frame (Right side) - REMOVED TOOLBAR
#         charts_frame = QFrame()
...
#         charts_title_font.setPointSize(16)
#         charts_title_font.setBold(True)
#         charts_title.setFont(charts_title_font)
#         charts_title.setStyleSheet("color: #495057; margin-bottom: 10px; padding: 5px;")
#         charts_title.setAlignment(Qt.AlignmentFlag.AlignCenter)
#         charts_layout.addWidget(charts_title)
        
#         # ✅ Create matplotlib figure - UNCHANGED SIZE
#         self.figure = Figure(figsize=(12, 18), dpi=80, facecolor='white')
#         self.canvas = FigureCanvas(self.figure)
#         self.canvas.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
#         self.canvas.setMinimumSize(700, 1000)
        
#         # ✅ NO TOOLBAR - REMOVED
#         # self.toolbar = NavigationToolbar(self.canvas, charts_frame)
#         # charts_layout.addWidget(self.toolbar)
        
#         charts_layout.addWidget(self.canvas, 1)  # Give canvas all the space
...
#         """Create the pie charts with proper formatting - UNCHANGED"""
#         try:
...
#             # ✅ Create subplots with PERFECT spacing - UNCHANGED
#             self.figure.subplots_adjust(
#                 top=0.95,      # More space at top
#                 bottom=0.05,   # More space at bottom
#                 left=0.1,      # More space on left
#                 right=0.75,    # Reserve space for legends on right
#                 hspace=0.7     # Excellent vertical spacing between plots
#             )
...
#                 axs[0].legend(labels_1, loc='center left', bbox_to_anchor=(1.05, 0.5), fontsize=11)
#             else:
#                 axs[0].text(0.5, 0.5, 'No Data Available', ha='center', va='center', 
#                            transform=axs[0].transAxes, fontsize=14, color='#6c757d')
            
#             axs[0].set_title('Internal vs External Anomalies', fontsize=14, fontweight='bold', pad=30)
#             axs[0].axis('equal')

#             # ✅ Chart 2: ERF Distribution
#             labels_2 = ['ERF < 0.95', '0.95 ≤ ERF < 1', 'ERF ≥ 1']
#             sizes_2 = [self.ERF_95, self.ERF_95_1, self.ERF_1]
#             colors_2 = ['#2ecc71', '#f39c12', '#e74c3c']
...
#                 axs[1].legend(labels_2, loc='center left', bbox_to_anchor=(1.05, 0.5), fontsize=11)
#             else:
#                 axs[1].text(0.5, 0.5, 'No Data Available', ha='center', va='center', 
#                            transform=axs[1].transAxes, fontsize=14, color='#6c757d')
            
#             axs[1].set_title('ERF Distribution', fontsize=14, fontweight='bold', pad=30)
#             axs[1].axis('equal')

#             # ✅ Chart 3: Depth Distribution
#             labels_3 = ['< 25%', '25% - 50%', '50% - 80%', '≥ 80%']
#             sizes_3 = [self.DEP_25, self.DEP_25_50, self.DEP_50_80, self.DEP_80_100]
#             colors_3 = ['#9b59b6', '#2ecc71', '#f39c12', '#8b4513']
...
#                 axs[2].legend(labels_3, loc='center left', bbox_to_anchor=(1.05, 0.5), fontsize=11)
#             else:
#                 axs[2].text(0.5, 0.5, 'No Data Available', ha='center', va='center', 
#                            transform=axs[2].transAxes, fontsize=14, color='#6c757d')
            
#             axs[2].set_title('Depth Distribution', fontsize=14, fontweight='bold', pad=30)
#             axs[2].axis('equal')
...
#         content_widget = QWidget()
#         content_widget.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
#         content_widget.setMinimumHeight(1800)
        
#         content_layout = QVBoxLayout(content_widget)
#         content_layout.setContentsMargins(25, 25, 25, 25)  # ✨ Increased margins
#         content_layout.setSpacing(25)  # ✨ Better spacing
        
#         # ✨ PREMIUM: Enhanced title with gradient and shadow effect
#         title = QLabel("🔧 Pipeline Highlights Dashboard")
#         title.setAlignment(Qt.AlignmentFlag.AlignCenter)
#         title_font = QFont("Segoe UI", 24, QFont.Weight.Bold)  # ✨ Better font
#         title.setFont(title_font)
#         title.setStyleSheet("""
#             QLabel {
...
#     def _create_statistics_section(self, parent_layout):
#         """Create the PREMIUM statistics and charts section"""
#         # ✨ PREMIUM: Enhanced splitter
#         splitter = QSplitter(Qt.Orientation.Horizontal)
#         splitter.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
...
#         # ✨ PREMIUM: Enhanced Statistics Frame
#         stats_frame = QFrame()
...
#             }
#         """)
#         stats_frame.setFixedWidth(420)  # ✨ Slightly wider
        
#         stats_layout = QVBoxLayout(stats_frame)
#         stats_layout.setSpacing(15)
        
#         # ✨ PREMIUM: Enhanced stats title
#         stats_title = QLabel("📈 Pipeline Statistics")
#         stats_title_font = QFont("Segoe UI", 18, QFont.Weight.Bold)
#         stats_title.setFont(stats_title_font)
...
#         # Statistics data with enhanced presentation
#         stats_groups = [
#             ("🔢 Anomaly Counts", [
...
#         # ✨ PREMIUM: Create enhanced grouped statistics
#         for group_title, stats_data in stats_groups:
#             # Group header
#             group_header = QLabel(group_title)
...
#                 }
#             """)
#             stats_layout.addWidget(group_header)
...
#                 # ✨ PREMIUM: Enhanced value display
#                 value_edit = QLineEdit(str(value))
#                 value_edit.setReadOnly(True)
#                 value_edit.setFixedWidth(90)
#                 value_edit.setFixedHeight(38)
#                 value_edit.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
#         # ✨ PREMIUM: Enhanced Charts Frame
#         charts_frame = QFrame()
#         charts_frame.setFrameStyle(QFrame.Shape.NoFrame)
#         charts_frame.setStyleSheet("""
#             QFrame {
#                 background: qlineargradient(x1:0, y1:0, x2:0, y2:1,
...
#         # ✨ PREMIUM: Enhanced charts title
#         charts_title = QLabel("📊 Data Visualization Dashboard")
#         charts_title_font = QFont("Segoe UI", 18, QFont.Weight.Bold)
#         charts_title.setFont(charts_title_font)
...
#         # ✨ PREMIUM: Enhanced matplotlib figure with better styling
#         self.figure = Figure(figsize=(12, 18), dpi=90, facecolor='#fefefe')  # ✨ Better DPI and background
#         self.canvas = FigureCanvas(self.figure)
#         self.canvas.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
#         self.canvas.setMinimumSize(720, 1000)
        
#         # ✨ PREMIUM: Canvas with subtle shadow effect
...
#             # ✨ Chart 2: ERF Distribution
#             labels_2 = ['Safe Zone\n(ERF < 0.95)', 'Caution Zone\n(0.95 ≤ ERF < 1)', 'Critical Zone\n(ERF ≥ 1)']
#             sizes_2 = [self.ERF_95, self.ERF_95_1, self.ERF_1]
