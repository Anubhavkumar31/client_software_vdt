...
class MyMainWindow(QMainWindow):
    ...
    def _build_splitter(self):
        ...
        # Create container widget for proximity line chart with top scrollbar + scroll area
        ...
        # Create scroll area without bottom horizontal scrollbar
        ...
        self.web_view2.setFixedSize(2500, 600)  # Increased size for better scrolling

        self.web_scroll_area.setWidget(self.web_view2)
        web_layout.addWidget(self.web_scroll_area)

        # Apply scrollbar theme to both scrollbars
        ...
        self.splitter.addWidget(self.main_web_page)  # Use the scrollable main web page instead of web_view directly
        ...
        def _on_splitter_moved(*_):
            # layout changed; if ready, re-apply mapping to keep ranges in sync
